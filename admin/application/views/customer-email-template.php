...
<body style="margin:30px;padding: 25px;">
	...
	<div style="border:1px solid #e7e7e7;padding:20px;border-radius: 8px;">
        ...
        <p>
		If you have any questions or feedback, please feel free to contact us at <a href="mailto:enquiry@bookmysalons.com" style="color:#30adb1;font-style:italic;">enquiry@bookmysalons.com </a>.
        </p>
		<br>
		<br>
		Thank you,<br>
