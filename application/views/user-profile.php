                        ...
                        <div class="edit-profile-details">
                            ...
                            <div class="row">
                               <div class="col-md-6">
                                   <div class="edit-profile1">
                              		   E-mail<br>
                                       <input type="text" class="edit-profile" disabled="disabled" value="<?php echo $usrconnect->email ?>" placeholder="E-mail" name="email_id">
                                   </div>
                              </div>
                                                                                                                                                                            			  <div class="col-md-6">
                                  <div class="edit-profile1">
                           ...
                           <div class="row">
                                <div class="col-md-6">
                                    <div class="edit-profile1">
                              			First Name<br>
                                        <input type="text" class="edit-profile" value="<?php echo $usrconnect->username ?>" placeholder="First Name" name="firstname">
                                    </div>
                                </div>
                                                                                                                                                            								<div class="col-md-6">
                                    <div class="edit-profile1">
