...
--
-- Host: localhost:3306
-- Generation Time: Jul 18, 2016 at 11:38 AM
...
--
-- Database: `techwbzd_bookmysalons`
--
...
--
DROP TABLE `cycle_slider`;
CREATE TABLE IF NOT EXISTS `cycle_slider` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shop_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
(1, 'mykey', 0, 0, '0000-00-00 00:00:00');
...
(1, 'BookMySaloon', 'http://www.bookmysalons.com/admin/assets/uploads/settings//1468827745.png', 'http://www.bookmysalons.com/admin/assets/uploads/settings//1468827745.ico', 'noreply@techware.co.in', 'sdsd', 'sdsd', 'ss@fghs', 'sd', 'sds');
...
(9, 7, 'http://www.bookmysalons.com/admin/assets/uploads/1-anushka2.png', 1),
